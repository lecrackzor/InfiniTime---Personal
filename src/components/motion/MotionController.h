...
namespace Pinetime {
  namespace Controllers {
    ...
    private:
      ...
      TickType_t lastStepNotifyTime = 0;
      bool stepsPendingNotify = false;
      int16_t lastNotifiedX = 0;
      int16_t lastNotifiedY = 0;
      int16_t lastNotifiedZ = 0;
      bool motionValuesSeeded = false;
